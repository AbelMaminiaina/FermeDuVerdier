    ...
    <section className="relative min-h-[90vh] flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img
          ...
          alt="Élevage de porcs de la Ferme du Vardier"
      ...
      <div className="container mx-auto px-4 relative z-10 py-20">
        ...
        >
          ...
          >
            Porc & Poisson{' '}
            <span className="text-terre-400">de qualité supérieure</span>{' '}
            à Madagascar
          </motion.h1>
          ...
          >
            Découvrez les produits authentiques de la Ferme du Vardier.
            Notre élevage porcin et notre pisciculture vous garantissent
            des produits frais et de qualité exceptionnelle.
          </motion.p>
