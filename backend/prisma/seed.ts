...
async function main() {
  ...
  const products = [
    ...
    // ==================== POISSON (Tilapia de Madagascar) ====================
    {
      ...
      description: 'Tilapia frais de Madagascar élevé dans notre pisciculture. Chair blanche et délicate, poisson emblématique de la Grande Île.',
      shortDescription: 'Tilapia frais de notre pisciculture malgache.',
      price: 20000,
      images: ['/images/poisson/tilapia.jpeg'],
      inStock: true,
      stockQuantity: 60,
      badges: ['populaire'] as ProductBadge[],
      characteristics: ['Poids: 1 kg', 'Poisson frais du jour', 'Chair blanche délicate', 'Élevage local Madagascar'],
      weight: '1 kg',
    },
    {
