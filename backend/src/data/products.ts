...
export const products: Product[] = [
  // Œufs frais
  {
    ...
    price: 20000,
    images: [
      '/images/products/oeufs-bio-6-1.jpg',
      '/images/products/oeufs-bio-6-2.jpg',
    ],
    inStock: true,
    stockQuantity: 50,
  ...
  },
  {
    ...
    originalPrice: 40000,
    images: [
      '/images/products/oeufs-bio-12-1.jpg',
      '/images/products/oeufs-bio-12-2.jpg',
    ],
    inStock: true,
    stockQuantity: 35,
  ...
  },
  {
    ...
    price: 81000,
    images: [
      '/images/products/oeufs-plateau-30.jpg',
    ],
    inStock: true,
    stockQuantity: 20,
    badges: ['plein-air'],
  ...
  // Œufs fécondés
  {
    ...
    price: 15500,
    images: [
      '/images/products/oeufs-fecondes-marans.jpg',
    ],
    inStock: true,
    stockQuantity: 24,
    badges: ['plein-air'],
  ...
  },
  {
    ...
    price: 13500,
    images: [
      '/images/products/oeufs-fecondes-sussex.jpg',
    ],
    inStock: true,
    stockQuantity: 18,
  ...
  },
  {
    ...
    price: 18000,
    images: [
      '/images/products/oeufs-fecondes-araucana.jpg',
    ],
    inStock: true,
    stockQuantity: 12,
    badges: ['nouveau'],
  ...
  },
  {
    ...
    price: 11000,
    images: [
      '/images/products/oeufs-fecondes-rousse.jpg',
    ],
    inStock: true,
    stockQuantity: 30,
    badges: ['plein-air', 'populaire'],
  ...
  },
  {
    ...
    price: 20000,
    images: [
      '/images/products/oeufs-fecondes-gauloise.jpg',
    ],
    inStock: true,
    stockQuantity: 8,
    badges: ['plein-air'],
  ...
  },
  {
    ...
    price: 22500,
    images: [
      '/images/products/oeufs-fecondes-soie.jpg',
    ],
    inStock: true,
    stockQuantity: 10,
    badges: ['nouveau'],
  ...
  // Poules vivantes
  {
    ...
    price: 81000,
    images: [
      '/images/products/poule-rousse-1.jpg',
      '/images/products/poule-rousse-2.jpg',
    ],
    inStock: true,
    stockQuantity: 25,
    badges: ['plein-air', 'populaire'],
  ...
  },
  {
    ...
    price: 112500,
    images: [
      '/images/products/poule-sussex-1.jpg',
      '/images/products/poule-sussex-2.jpg',
    ],
    inStock: true,
    stockQuantity: 15,
    badges: ['plein-air'],
  ...
  },
  {
    ...
    price: 135000,
    images: [
      '/images/products/poule-marans-1.jpg',
      '/images/products/poule-marans-2.jpg',
    ],
    inStock: true,
    stockQuantity: 12,
    badges: ['plein-air', 'populaire'],
  ...
  },
  {
    ...
    price: 157500,
    images: [
      '/images/products/poule-araucana-1.jpg',
    ],
    inStock: true,
    stockQuantity: 8,
  ...
  },
  {
    ...
    price: 180000,
    images: [
      '/images/products/poule-soie-1.jpg',
      '/images/products/poule-soie-2.jpg',
    ],
    inStock: true,
    stockQuantity: 6,
    badges: ['nouveau'],
  ...
  // Accessoires
  {
    ...
    price: 850000,
    images: [
      '/images/products/poulailler-1.jpg',
      '/images/products/poulailler-2.jpg',
    ],
    inStock: true,
    stockQuantity: 5,
    badges: [],
  ...
  },
  {
    ...
    price: 112000,
    images: [
      '/images/products/aliment-pondeuses.jpg',
    ],
    inStock: true,
    stockQuantity: 40,
  ...
  {
    id: 'litiere-chanvre-100l',
    name: 'Litière Chanvre Premium 100L',
    slug: 'litiere-chanvre-premium-100l',
    category: 'accessoires',
    description: 'Litière de chanvre premium ultra-absorbante. Naturelle et compostable, elle absorbe jusqu\'à 4 fois son poids en humidité. Excellente pour le confort de vos poules et le contrôle des odeurs.',
    shortDescription: 'Litière chanvre ultra-absorbante et compostable.',
    price: 83000,
    images: [
      '/images/products/litiere-chanvre.jpg',
    ],
    inStock: true,
    stockQuantity: 25,
    badges: ['bio'],
    metadata: {
      weight: '100 L (environ 12 kg)',
    },
    characteristics: [
      '100% chanvre français',
      'Ultra-absorbante',
      'Compostable',
      'Contrôle des odeurs',
      'Dure plus longtemps que la paille',
    ],
    createdAt: '2024-01-10',
    updatedAt: '2024-01-10',
  },
  ...
  {
    id: 'complement-coquilles-huitres',
    name: 'Coquilles d\'Huîtres Broyées 5kg',
    slug: 'coquilles-huitres-broyees-5kg',
    category: 'accessoires',
    description: 'Source naturelle de calcium indispensable pour des coquilles d\'œufs solides. À mettre à disposition en libre-service. Les poules se servent selon leurs besoins.',
    shortDescription: 'Calcium naturel pour coquilles solides.',
    price: 40000,
    images: [
      '/images/products/coquilles-huitres.jpg',
    ],
    inStock: true,
    stockQuantity: 45,
    badges: ['bio'],
    ...
    characteristics: [
      '100% coquilles d\'huîtres',
      'Source de calcium naturel',
      'En libre-service',
      'Améliore la solidité des coquilles',
    ],
